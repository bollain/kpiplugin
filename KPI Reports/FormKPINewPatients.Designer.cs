...
{
    partial class FormKPINewPatients
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.label3.Text = "Used to get a list of all new patients within the" +
    " date range.";
            ...
            this.Load += new System.EventHandler(this.FormKPINewPatients_Load);
