...
{
	public partial class FormKPINoShowAppt:Form {

		public FormKPINoShowAppt() {
			InitializeComponent();
			Lan.F(this);
		}

		private void FormKPINoShowAppt_Load(object sender,EventArgs e) {
			dateStart.SelectionStart=DateTime.Today.AddYears(-1);
			dateEnd.SelectionStart=DateTime.Today;
		}

		private void butOK_Click(object sender,EventArgs e) {
			DataTable tablePats=KPINoShowAppt.GetNoShowAppt(dateStart.SelectionStart,dateEnd.SelectionStart);

            ReportComplex report=new ReportComplex(true,false);
			report.ReportName=Lan.g(this,"Patients who missed their appointment");
			report.AddTitle("Title",Lan.g(this, "Patients who missed their appointment"));
