...
namespace KPIReporting.KPIForm
{
    partial class FormKPICancel
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label3.Text = "Used to get a list of all patients who cancelled short notice within the" +
    " date range.";
            ...
            this.Name = "FormKPICancel";
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
            this.Text = "Patients who cancelled short notice";
            this.Load += new System.EventHandler(this.FormKPICancel_Load);
